...
//-------------------------------------------------------------------------------------------
//constructors
lemmatizer::lemmatizer(byte *abData, int iDataLen) {
	this->abData = abData;
	this->iDataLen = iDataLen;
}

lemmatizer::lemmatizer(const char *acFileName) {
...
int lemmatizer::SizeOfTree() const{
	return iDataLen - DataStart;
}

//-------------------------------------------------------------------------------------------
//lemmatize word according to this data
char *lemmatizer::Lemmatize(const char *acWord, char *acOutBuffer) const{
...
//-------------------------------------------------------------------------------------------
//returns string representation of this node and all its sub nodes
void lemmatizer::ToString(ostream &os, dword iStartAddr, int iDepth, char *acParSufx, char *acParDev, char cNewChar) const {
...
void lemmatizer::ToStringHex(ostream &os) const {
	os << dec << noshowbase;
...
void lemmatizer::SaveBinary(ostream &os) const {
...
void lemmatizer::LoadBinary(istream &is) {
	iDataLen =0;
...
//-------------------------------------------------------------------------------------------
//save all data from this object to binary file
void lemmatizer::SaveBinary(const char *acFileName) const {
...
//-------------------------------------------------------------------------------------------
//loads all data needed from binary file
void lemmatizer::LoadBinary(const char *acFileName) {
